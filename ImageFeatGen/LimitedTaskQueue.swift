...
class LimitedTaskQueue {
    static var shared = LimitedTaskQueue(limit: 20)
    
    private let semaphore: DispatchSemaphore
    private let queue = DispatchQueue(label: "com.memz233.Greatdori.ImageFeatGen.limited-task-queue", attributes: .concurrent)
